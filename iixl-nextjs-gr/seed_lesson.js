...
const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://student:Tf5bKtt1PjE9o7L4@cluster0.o89y9o8.mongodb.net/test?retryWrites=true&w=majority";
...
async function seed() {
    try {
        ...
        console.log("Connected to DB, checking for expanded-form lesson...");
        ...
        console.log("Lesson 'expanded-form' inserted/updated successfully!");
        process.exit(0);
    } catch (e) {
